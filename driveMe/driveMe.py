...
def book_button():
    ...
    cur.execute(query)
    conn.commit()
    return "<p style='text-align:center'> Booked Successfully </p> <a href='/profile' style='text-align:center'>Go to booking </a>"
    ...
    if "user" in session:
        if request.method == "POST":
            ...
            try:
                ...
                msg='cannot register the vehicle'
